...
namespace CoatingMgr
{
    public partial class FormIn : Form
    {
        ...
        private void TbBarCode_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                this.dgvStockData.Rows.Add(0, tbBarCode.Text, tbName.Text, tbColor.Text, tbType.Text, tbWeight.Text, tbModel.Text, cbSearchStock.Text, tbProductionDate.Text, tbExpiryDate.Text, _userName, DateTime.Now.ToString("yyyy-MM-dd"), DateTime.Now.ToString("HH:mm:ss"), "入库", " ", " ");
