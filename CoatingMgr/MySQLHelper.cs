    ...
    class MySQLHelper
    {
        ...
        public static bool CreateDB()
        {
            ...
            if (Properties.Settings.Default.MySQLIP.Equals(string.Empty) 
                || Properties.Settings.Default.MySQLPort.Equals(string.Empty)
                || Properties.Settings.Default.MySQLUser.Equals(string.Empty)
                || Properties.Settings.Default.MySQLPwd.Equals(string.Empty))
            {
            ...
            try
            {
                string connStr = "Data Source = " + Properties.Settings.Default.MySQLIP + ";Persist Security Info = yes; UserId = " + Properties.Settings.Default.MySQLUser + "; PWD = " + Properties.Settings.Default.MySQLPwd;
        ...
        public static bool CreateTable(string tableName, string[] colNames, string[] colTypes)
        {
            ...
            string connStr = "server = " + Properties.Settings.Default.MySQLIP + "; port = " + Properties.Settings.Default.MySQLPort
                + "; user = " + Properties.Settings.Default.MySQLUser + "; password = " + Properties.Settings.Default.MySQLPwd + "; database = " + Common.DBFileName + ";";
